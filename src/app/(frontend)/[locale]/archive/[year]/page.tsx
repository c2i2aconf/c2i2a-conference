    ...
    <div className="container py-12 md:py-24">
      ...
      <div className="mb-16">
        <Badge className="mb-4 bg-muted text-muted-foreground hover:bg-muted">
          Archive {edition.year}
        </Badge>
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">{edition.title}</h1>
        {edition.theme && (
          <p className="text-xl text-primary font-medium">{edition.theme}</p>
        )}
      </div>
